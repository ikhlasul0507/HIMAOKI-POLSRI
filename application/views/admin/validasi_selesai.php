...
<BR>
  ...
  <div id="fh5co-main">
      <div class="fh5co-more-contact">
        <div class="container">
         <CENTER> <h1 class="MT-3">VALIDASI SELESAI</h1></CENTER>
          ...
          <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="bayar" value="<?= $peserta['bayar'];?>">
                    <input type="hidden" name="absen_pagi" value="<?= $peserta['absen_pagi'];?>">
                  
                    <input type="hidden" name="absen_siang" value="<?= $peserta['absen_siang'];?>">
                    <input type="hidden" name="makan_siang" value="<?= $peserta['makan_siang'];?>">
